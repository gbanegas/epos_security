...
//void testeDecodeEncode();
//void testeConstrutorCopia();
void testeUserAgent();
...
/*void createInvite(char *msgInvite)
{
	strcat(msgInvite, "INVITE sip:marconi@radio.org SIP/2.0\r\n");
	strcat(msgInvite, "zzz: 70\r\n");
	strcat(msgInvite, "Allow: INVITE, ACK, OPTIONS, CANCEL, BYE\r\n");
	strcat(msgInvite, "Allow-Events: presence, test\r\n");
	strcat(msgInvite, "u: test1 , test2 \r\n");
	strcat(msgInvite, "Call-ID: 123456789@lab.high-voltage.org\r\n");
	strcat(msgInvite, "Contact: \"Mr. Watson\" <sip:watson@worcester.bell-telephone.com> ;q=0.7 ;expires=3600, \"Mr. Watson\" <mailto:watson@bell-telephone.com> ;q=0.1\r\n");
	strcat(msgInvite, "m: *\r\n");
	strcat(msgInvite, "Content-Disposition: attachment; filename=smime.p7s;handling=required\r\n");
	strcat(msgInvite, "Content-Length: 158\r\n");
	strcat(msgInvite, "Content-Type: application/sdp\r\n");
	strcat(msgInvite, "c: text/html; charset=ISO-8859-4\r\n");
	strcat(msgInvite, "CSeq: 1 INVITE\r\n");
	strcat(msgInvite, "Event: presence\r\n");
	strcat(msgInvite, "Event: presence; id=1234\r\n");
	strcat(msgInvite, "Expires: 3600\r\n");
	strcat(msgInvite, "From: Nikola Tesla <sip:n.tesla@high-voltage.org>;tag=76341\r\n");
	strcat(msgInvite, "f: Anonymous <sip:c8oqz84zk7z@privacy.org>\r\n");
	strcat(msgInvite, "Max-Forwards: 70\r\n");
	strcat(msgInvite, "Record-Route: <sip:server10.biloxi.com;lr>, <sip:bigbox3.site3.atlanta.com;lr>\r\n");
	strcat(msgInvite, "Require: foo\r\n");
	strcat(msgInvite, "Route: <sip:bigbox3.site3.atlanta.com;lr>, <sip:server10.biloxi.com;lr>\r\n");
	strcat(msgInvite, "Route: <sip:server13.atlanta.com;lr>\r\n");
	strcat(msgInvite, "Route: <sip:server1.atlanta.com;transport=udp;user=phone;lr>\r\n");
	strcat(msgInvite, "Route: <sip:server2.atlanta.com;transport=udp;user=phone>;lr\r\n"); //Não deve detectar lr!
	strcat(msgInvite, "Route: <sip:server3.atlanta.com;transport=udp;user=phone>;teste;lr\r\n"); //Não deve detectar lr!
	strcat(msgInvite, "Subscription-State: active;expires=600\r\n");
	strcat(msgInvite, "Subscription-State: active ; expires=500\r\n");
	strcat(msgInvite, "Subscription-State: terminated; reason=timeout ; retry-after=400\r\n");
	strcat(msgInvite, "To: G. Marconi <sip:Marconi@radio.org>\r\n");
	strcat(msgInvite, "t: sip:+12125551212@server.phone2net.com;tag=287447\r\n");
	strcat(msgInvite, "Unsupported: 100rel, foo\r\n");
	strcat(msgInvite, "Via: SIP/2.0/UDP lab.high-voltage.org:5060;branch=z9hG4bKfw19b\r\n");
	strcat(msgInvite, "Via: SIP / 2.0 / UDP first.example.com: 4000;ttl=16;maddr=224.2.0.1;branch=z9hG4bKa7c6a8dlze.1, SIP/2.0/UDP first.example.com\r\n");
	//strcat(msgInvite, "Warning: 307 isi.edu \"Session parameter foo not understood\"\r\n");
	//strcat(msgInvite, "WWW-Authenticate: Digest realm=\"atlanta.com\", domain=\"sip:boxesbybob.com\", qop=\"auth\", nonce=\"f84f1cec41e6cbe5aea9c8e88d359\", opaque=\"\", stale=FALSE, algorithm=MD5\r\n");
	//strcat(msgInvite, "Accept: application/sdp;level=1, application/x-private, text/html\r\n");
	//strcat(msgInvite, "Accept-Encoding: gzip, text/plain\r\n");
	//strcat(msgInvite, "Accept-Encoding: \r\n");
	//strcat(msgInvite, "Accept-Language: da, en-gb;q=0.8, en ;q=0.7, *\r\n");
	//strcat(msgInvite, "Alert-Info: <http://www.example.com/sounds/moo.wav>\r\n");
	//strcat(msgInvite, "Authentication-Info: nextnonce=\"47364c23432d2e131a5fb210812c\"\r\n");
	//strcat(msgInvite, "Authorization: Digest username=\"Alice\", realm=\"atlanta.com\", nonce=\"84a4cc6f3082121f32b42a2187831a9e\", response=\"7587245234b3434cc3412213e5f113a5432\"\r\n");
	//strcat(msgInvite, "Call-Info: <http://wwww.example.com/alice/photo.jpg> ;purpose=icon, <http://www.example.com/alice/> ;purpose=info\r\n");
	//strcat(msgInvite, "Content-Encoding: text/plain, gzip\r\n");
	//strcat(msgInvite, "Content-Language: en, fr\r\n");
	//strcat(msgInvite, "Date: Sat, 13 Nov 2010 23:29:00 GMT\r\n");
	//strcat(msgInvite, "Error-Info: <sip:not-in-service-recording@atlanta.com>\r\n");
	//strcat(msgInvite, "In-Reply-To: 70710@saturn.bell-tel.com, 17320@saturn.bell-tel.com\r\n");
	//strcat(msgInvite, "MIME-Version: 1.0\r\n");
	//strcat(msgInvite, "Min-Expires: 60\r\n");
	//strcat(msgInvite, "Organization: Boxes by Bob\r\n");
	//strcat(msgInvite, "Priority: normal\r\n");
	//strcat(msgInvite, "Proxy-Authenticate: Digest realm=\"atlanta.com\", domain=\"sip:ss1.carrier.com\", qop=\"auth\", nonce=\"f84f1cec41e6cbe5aea9c8e88d359\", opaque=\"\", stale=FALSE, algorithm=MD5\r\n");
	//strcat(msgInvite, "Proxy-Authorization: Digest username=\"Alice\", realm=\"atlanta.com\", nonce=\"c60f3082ee1212b402a21831ae\", response=\"245f23415f11432b3434341c022\"\r\n");
	//strcat(msgInvite, "Proxy-Require: foo, 100rel\r\n");
	//strcat(msgInvite, "Reply-To: Bob <sip:bob@biloxi.com>\r\n");
	//strcat(msgInvite, "Retry-After: 18000;duration=3600\r\n");
	//strcat(msgInvite, "Retry-After: 120 (I'm in a meeting)\r\n");
	//strcat(msgInvite, "Server: HomeServer v2\r\n");
	//strcat(msgInvite, "Subject: About That Power Outage...\r\n");
	//strcat(msgInvite, "Supported: 100rel, foo\r\n");
	//strcat(msgInvite, "Timestamp: 1.234 2.7893\r\n");
	//strcat(msgInvite, "User-Agent: Softphone Beta1.5\r\n");
	strcat(msgInvite, "\r\n");
	strcat(msgInvite, "v=0\r\n");
	strcat(msgInvite, "o=Tesla 2890844526 2890844526 IN IP4 lab.high-voltage.org\r\n");
	strcat(msgInvite, "s=Phone Call\r\n");
	strcat(msgInvite, "c=IN IP4 100.101.102.103\r\n");
	strcat(msgInvite, "t=0 0\r\n");
	strcat(msgInvite, "m=audio 49170 RTP/AVP 0\r\n");
	strcat(msgInvite, "a=rtpmap:0 PCMU/8000\r\n");
}
...
void testeDecodeEncode()
{
	cout << "+++++ testeDecodeEncode +++++\n\n";

	char msgInvite[3000];
	msgInvite[0] = 0;

	createInvite(msgInvite);

	cout << "********************************************\n";
	cout << "Mensagem recebida: \nTamanho: " << strlen(msgInvite) << "\n" << msgInvite << "\n";

	cout << "Decoding..\n";
	SipMessage *msg = SipMessage::decodeMsg(msgInvite);

	msgInvite[0] = 0;
	cout << "Encoding..\n";
	if (msg)
	{
		if (!msg->encode(msgInvite))
			cout << "Erro ao codificar mensagem\n";
	}
...
void testeConstrutorCopia()
{
	...
	cout << "********************************************\n";
	cout << "Mensagem recebida: \nTamanho: " << strlen(msgInvite) << ", " << msgInvite << "\n";

	SipRequestInvite *msg = (SipRequestInvite *) SipMessage::decodeMsg(msgInvite);
	SipRequestInvite *msg2 = new SipRequestInvite(*msg);

	msgInvite[0] = 0;
	if (msg2)
	{
		if (!msg2->encode(msgInvite))
			cout << "Erro ao codificar mensagem\n";
	}
...
Thread *sendAudioThread = 0;
bool sendAudioTerminated = false;
int sendAudio(UserAgent *ua);

Thread *sendNotifyThread = 0;
bool sendNotifyTerminated = false;
...
int createSession(UserAgent *ua, const char *to)
{
	cout << "+++++ createSession +++++\n";
	...
	{
		cout << "+++++ Create Invite +++++\n";
		SipRequestInvite *invite = ua->getUserAgentClient()->createInvite(to);

		cout << "+++++ Send Invite +++++\n";
		ua->getUserAgentClient()->sendRequest(invite);
		//delete invite;
...
void testeUserAgent()
{
	...
	UserAgent *ua = SipManager::getInstance()->createUserAgent(from);

	Thread t(createSession, ua, to);

	Alarm::delay(300000 * 1000);
	cout << "+++++ Finished +++++\n";
	SipManager::deleteInstance();
	t.exit(0);
}
...
int sendNotify(UserAgent *ua)
{
	...
	{
		SipPidfXmlBasicElement element = openClosed ? SIP_PIDF_XML_OPEN : SIP_PIDF_XML_CLOSED;
...
/**	};
	...
	for (int i = 0; i < 10; i++)
	{
		//db<SendRTP>(INF) << "sendAudio -> sizeof(packet) = " << sizeof(packet) <<
		...
		for (unsigned int j = 0; j < (sizeof(packet) / sizeof(packet[0])); j++)
		{
			...
			sendRTP.sendData("10.0.0.102", 8000, packet[j], sizeof(packet[j])); //ua->sendData("169.254.1.24", 5062, packet[j], sizeof(packet[j]));
